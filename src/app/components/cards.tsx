...
export default function Cards(){
    ...
    return (
        ...
        {listProject?.map((project) => (
            <li key={project.id} className="flex flex-col justify-between sm:w-full lg:w-[400px] md:h-[200px] lg:h-74 p-6 border rounded-md shadow bg-[#080808] border-[#5d1d29e6]">
                <div>
                    ...
                    <Link href={project.html_url} target="_blank" className="flex hover:text-[#b1b1b1] text-white ">
                    ...
                    <Link href={project.homepage} target="_blank" className="flex hover:text-[#b1b1b1] text-white ">
