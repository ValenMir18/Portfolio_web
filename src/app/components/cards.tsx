...
export default function Cards(){
    ...
    return (
        ...
        {listProject?.map((project) => (
            <li key={project.id} className="flex flex-col justify-between w-full md:h-[200px] lg:h-74 p-6 bg-white border border-gray-200 rounded-md shadow dark:bg-gray-800 dark:border-gray-700">
                <div>
                    ...
                    <Link href={project.url} target="_blank" className="flex hover:text-rose-800 text-white ">
